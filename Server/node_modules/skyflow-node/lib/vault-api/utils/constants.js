...
const SKYFLOW_ERROR_CODE = {
    ...
    VAULTID_IS_REQUIRED: { code: 400, description: logs_1.default.errorLogs.VAULTID_IS_REQUIRED },
    EMPTY_VAULTID_IN_INIT: { code: 400, description: logs_1.default.errorLogs.EMPTY_VAULTID_IN_INIT },
    VAULTURL_IS_REQUIRED: { code: 400, description: logs_1.default.errorLogs.VAULTURL_IS_REQUIRED },
    EMPTY_VAULTURL_IN_INIT: { code: 400, description: logs_1.default.errorLogs.EMPTY_VAULTURL_IN_INIT },
    INVALID_VAULTURL_IN_INIT: { code: 400, description: logs_1.default.errorLogs.INVALID_VAULTURL_IN_INIT },
    GET_BEARER_TOKEN_IS_REQUIRED: {
        code: 400,
        description: logs_1.default.errorLogs.GET_BEARER_TOKEN_IS_REQUIRED,
    },
