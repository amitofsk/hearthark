...
const DoctorPage = () => {
  return (
    <div>
      ...
      <br></br>
      <button type="button" onClick={()=>readPatientFile(1, document.getElementById('nameWanted'), document.getElementById('btest'))}>Get Patient Info File</button>
      <br></br>
      <button type="button" onClick={() => switchMusic()}>Load patient music File</button>
      <br></br>
